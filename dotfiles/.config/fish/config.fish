...
if test -f /Users/remisalmon/Miniconda/bin/conda
    eval /Users/remisalmon/Miniconda/bin/conda "shell.fish" "hook" $argv | source
else
    if test -f "/Users/remisalmon/Miniconda/etc/fish/conf.d/conda.fish"
        . "/Users/remisalmon/Miniconda/etc/fish/conf.d/conda.fish"
    else
        set -x PATH "/Users/remisalmon/Miniconda/bin" $PATH
    end
end
# <<< conda initialize <<<
